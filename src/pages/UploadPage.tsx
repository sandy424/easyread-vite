    ...
    <div className="bg-mint-50 w-full min-h-screen flex justify-center items-center font-ko">
      ...
      <div className="w-full max-w-lg px-4 py-8">
        <div className="bg-white border border-mint-100 rounded-xl p-7">
          {/* 제목 */}
          <div className="mb-5">
            <label className="block text-lg font-medium text-mint-600 mb-1.5">제목</label>
            <input
              type="text"
              maxLength={200}
              ...
              className="w-full px-3 py-2.5 text-base border border-mint-100 rounded-lg bg-white text-mint-900 outline-none focus:border-mint-600 focus:ring-2 focus:ring-mint-50"
            />
          </div>

          {/* 파일 드롭존 */}
          <div className="mb-5">
            <label className="block text-lg font-medium text-mint-600 mb-1.5">파일</label>
            <label
